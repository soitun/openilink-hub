export const queryKeys = {
  ...
  bots: {
    ...
    messages: (id: string, cursor?: string) => ["bots", id, "messages", { cursor }] as const,
    stats: () => ["bots", "stats"] as const,
    webhookLogs: (botId: string, channelId?: string) => ["bots", botId, "webhook-logs", { channelId }] as const,
  },
  ...
  apps: {
    ...
    eventLogs: (appId: string, iid: string) => ["apps", appId, "installations", iid, "event-logs"] as const,
    apiLogs: (appId: string, iid: string) => ["apps", appId, "installations", iid, "api-logs"] as const,
  },
